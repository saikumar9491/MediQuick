      ...
      <div className="max-w-7xl mx-auto p-2 md:p-6 lg:p-10">
        ...
        <div className="bg-white shadow-sm flex flex-col md:flex-row gap-8 p-4 md:p-10 rounded-sm">
          ...
          <div className="w-full md:w-[45%] flex flex-col gap-4 sticky top-24 h-fit">
            <div className="border border-gray-100 flex items-center justify-center p-12 h-[450px] md:h-[550px] bg-[#fdfdfd] relative overflow-hidden group">
              ...
              <button 
                ...
                className={`absolute top-4 right-4 w-11 h-11 flex items-center justify-center rounded-full bg-white shadow-md border border-gray-100 transition-all z-10 hover:scale-110 active:scale-95 ${isWishlisted ? 'text-red-500' : 'text-gray-300'}`}
              >
                <span className="text-2xl">{isWishlisted ? '❤️' : '🤍'}</span>
              </button>

              <div className="absolute top-4 left-4 bg-green-600 text-white text-[10px] font-black px-3 py-1 rounded-full animate-pulse uppercase shadow-md">
                25% Off
              </div>
            </div>
            ...
            <div className="flex gap-3 w-full">
              <button 
                onClick={() => { addToCart(medicine); alert("Added to cart!"); }} 
                className="flex-1 bg-[#ff9f00] text-white py-4 font-black uppercase text-sm shadow-lg hover:bg-[#f39700] transition-colors flex items-center justify-center gap-2"
              >
                🛒 ADD TO CART
              </button>
              <button 
                onClick={handleBuyNow} 
                className="flex-1 bg-[#fb641b] text-white py-4 font-black uppercase text-sm shadow-lg hover:bg-[#f05a18] transition-colors flex items-center justify-center gap-2"
              >
                ⚡ BUY NOW
              </button>
            </div>
          ...
          <div className="flex-1 flex flex-col">
            <nav className="text-[11px] text-gray-400 mb-2 font-black uppercase tracking-widest">
              Home {'>'} {medicine.category || 'Pharmacy'} {'>'} {medicine.brand}
            </nav>
            
            <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-2 uppercase italic tracking-tighter leading-none">
              {medicine.name}
            </h1>

            <div className="flex items-center gap-3 mb-6">
              <span className="bg-green-700 text-white text-[12px] font-bold px-2 py-0.5 rounded flex items-center gap-1 shadow-sm">
                4.4 ★
              </span>
              <span className="text-gray-400 text-[11px] font-black uppercase tracking-widest">
                1,240 Ratings & 158 Reviews
              </span>
              <span className="ml-auto text-blue-600 font-black italic text-[10px] bg-blue-50 px-3 py-1 rounded-full border border-blue-100 flex items-center gap-1 uppercase">
            ...
            <div className="flex items-baseline gap-4 mb-2">
              ...
              <span className="text-green-600 font-black text-sm uppercase italic tracking-widest animate-bounce">
            ...
            <div className="bg-gray-50 border border-dashed border-gray-300 p-5 rounded-sm mb-10">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 text-sm">
                    ...
                    <p className="text-gray-600 text-xs"><span className="font-bold text-gray-900">Bank Offer</span> 10% instant discount on HDFC Bank Credit Cards. <span className="text-blue-600 font-bold cursor-pointer underline">T&C</span></p>
                  </div>
                  <div className="flex items-start gap-3 text-sm">
                    <span className="text-green-600 font-bold">🏷️</span>
                    <p className="text-gray-600 text-xs"><span className="font-bold text-gray-900">Amritsar Exclusive</span> Get free express delivery within 2 hours for orders above ₹499.</p>
                  </div>
                </div>
            </div>
            ...
            <div className="border-t border-gray-100 pt-8">
              ...
              <p className="text-gray-700 text-sm italic font-medium leading-relaxed">
                {medicine.description || "Source: Verified Amritsar Hub. Guaranteed quality and strictly monitored temperature-controlled storage."}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 bg-white p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-10 border-b border-gray-100 pb-4">
              <h2 className="text-2xl font-black text-gray-900 uppercase italic tracking-tighter border-l-4 border-blue-600 pl-4">
                Similar Products You Might Like
              </h2>
              <button className="text-blue-600 font-black text-[10px] uppercase tracking-widest hover:underline decoration-2">
                View All Category
              </button>
          </div>
