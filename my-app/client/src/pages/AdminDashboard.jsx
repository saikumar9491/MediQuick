...
const AdminDashboard = () => {
  ...
  const todayOrders = completedOrders.filter(o => new Date(o.createdAt).toDateString() === today.toDateString());
  const todayRevenue = todayOrders.reduce((sum, o) => sum + o.totalAmount, 0);

  const thisMonth = new Date(today.getFullYear(), today.getMonth(), 1);
  const monthOrders = completedOrders.filter(o => new Date(o.createdAt) >= thisMonth);
          ...
          <motion.div key="overview" initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -15 }} className="space-y-6 text-xs text-[#1F2937]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-black text-slate-800 leading-none">₹{todayRevenue}</h3>
              ...
              <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-black text-slate-800 leading-none">{inventory.length}</h3>
                  <span className="inline-block mt-2.5 px-2 py-0.5 rounded bg-emerald-500 text-[8px] font-black text-white uppercase tracking-wider">Total Products</span>
                </div>
              ...
              <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-black text-slate-800 leading-none">{customersList.length}</h3>
                  <span className="inline-block mt-2.5 px-2 py-0.5 rounded bg-rose-500 text-[8px] font-black text-white uppercase tracking-wider">Registered Users</span>
                </div>
              ...
              <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-black text-slate-800 leading-none">₹{totalProfit}</h3>
                  <span className="inline-block mt-2.5 px-2 py-0.5 rounded bg-orange-500 text-[8px] font-black text-white uppercase tracking-wider">Total Profit</span>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6 lg:col-span-1">
                ...
                <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm">
                  <span className="text-[10px] font-bold text-orange-500 uppercase tracking-wider">Total Orders</span>
                  <div className="flex items-center gap-2 mt-1">
                    <h4 className="text-2xl font-black text-slate-800">{orders.length}</h4>
                  </div>
                  <span className="block text-[9px] text-slate-400 font-bold tracking-wide mt-1.5">All time orders placed</span>
                </div>
                ...
                <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <h4 className="text-2xl font-black text-slate-800">₹{monthRevenue}</h4>
                  </div>
                  <span className="block text-[9px] text-slate-400 font-bold tracking-wide mt-1.5">This Month's Revenue</span>
                </div>
              </div>
              ...
              <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm lg:col-span-2 flex flex-col justify-between">
                <div>
                  <h4 className="text-xs font-black text-slate-800 uppercase tracking-wider">30-Day Revenue Trend</h4>
                </div>
                <div className="h-36 w-full mt-2">
                  <SVGBarChart data={getTimelineData()} color="#F97316" />
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm lg:col-span-2 grid grid-cols-2 divide-x divide-y divide-[#E5E7EB] border-collapse">
                ...
                <div className="p-4 flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-sm font-black">₹{monthRevenue}</h5>
                ...
                <div className="p-4 flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-sm font-black">{orders.filter(o=>o.status==='Confirmed'||o.status==='Shipped'||o.status==='Out for Delivery').length}</h5>
                    <span className="text-[10px] text-slate-400 font-bold">Active / Pending Orders</span>
                  </div>
                </div>
                ...
                <div className="p-4 flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-sm font-black">{completedOrders.length}</h5>
                    <span className="text-[10px] text-slate-400 font-bold">Completed Orders</span>
                  </div>
                </div>
                ...
                <div className="p-4 flex items-start gap-4">
                  ...
                  <div>
                    <h5 className="text-sm font-black">{lowStockProducts.length}</h5>
                    <span className="text-[10px] text-slate-400 font-bold">Low Stock Items</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 lg:col-span-1">
                ...
                <div className="bg-[#F97316] text-white rounded-lg p-5 shadow-sm flex flex-col justify-between">
                  <div>
                    ...
                    <h4 className="text-xl font-black mt-1">{monthOrders.length}</h4>
                  </div>
                  <div className="mt-3">
                    <SparklineOrange />
                  </div>
                ...
                <div className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-lg p-5 shadow-sm flex flex-col justify-between">
                  <div>
                    ...
                    <h4 className="text-xl font-black text-slate-800 mt-1">{inventory.length}</h4>
                  </div>
                  <div className="mt-3">
                    <SparklineBlue />
                  </div>
